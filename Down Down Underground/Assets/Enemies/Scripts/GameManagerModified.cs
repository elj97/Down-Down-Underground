...
namespace SAE
{
    public class GameManagerModified : MonoBehaviour
    {
        ...
        private void Update()
        {
            ...
            this.yellowPlayer.velocity = new Vector3(axisValues.x, -axisValues.y, 0f) * this.moveSpeed;
            ...
            this.bluePlayer.velocity = new Vector3(axisValues.x, -axisValues.y, 0f) * this.moveSpeed;

            axisValues = SAE.ArcadeMachine.PlayerJoystickAxisStatic(ArcadeMachine.PlayerColorId.RED_PLAYER);
            this.redPlayer.velocity = new Vector3(axisValues.x, -axisValues.y, 0f) * this.moveSpeed;

            axisValues = SAE.ArcadeMachine.PlayerJoystickAxisStatic(ArcadeMachine.PlayerColorId.GREEN_PLAYER);
            this.greenPlayer.velocity = new Vector3(axisValues.x, -axisValues.y, 0f) * this.moveSpeed;
